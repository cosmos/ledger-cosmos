...
static const key_subst_t value_substitutions[] = {
        {"persistence-sdk/MsgSend",                        "Send"},
        {"persistence-sdk/MsgDelegate",                    "Delegate"},
        {"persistence-sdk/MsgUndelegate",                  "Undelegate"},
        {"persistence-sdk/MsgBeginRedelegate",             "Redelegate"},
        {"persistence-sdk/MsgSubmitProposal",              "Propose"},
        {"persistence-sdk/MsgDeposit",                     "Deposit"},
        {"persistence-sdk/MsgVote",                        "Vote"},
        {"persistence-sdk/MsgWithdrawDelegationReward",    "Withdraw Reward"},
        {"persistence-sdk/MsgWithdrawValidatorCommission", "Withdraw Val. Commission"},
};
