...
[![GithubActions](https://github.com/Finschia/ledger-finschia/actions/workflows/main.yml/badge.svg)](https://github.com/Finschia/ledger-finschia/blob/main/.github/workflows/main.yaml)
...
This project contains the Finschia app for Ledger Nano S and X.

- Ledger Nano S/X Finschia app
- Specs / Documentation
- C++ unit tests
- Zemu tests
...
Download a release from here (https://github.com/Zondax/ledger-finschia/releases). You only need `zxtool.sh`
